...
HTML;
		...
		$tipContent .= '</div>';
		$tipContent .= '<div class="st-footer">Read more: <a href="https://www.biblegateway.com/passage/?search='.urlencode($scripture_tip['pattern']).'" title="www.biblegateway.com/search='.$scripture_tip['pattern'].' (opens a new window)" target="_blank">www.biblegateway.com/?search='.urlencode($scripture_tip['pattern']).'</a><span class="st-footer-ellipse">&hellip;</span></div>';
		$tipContent .= '</div>';
